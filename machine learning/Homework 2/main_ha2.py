import os
os.chdir('C:/Users/rossw/Documents/MAE Program/Q2/Machine Learning 425/Homework 2')
...
for idx, column in enumerate(sat.T):
    cmin = column.min()
    cmax = column.max()
    divide = cmax - cmin
    sat[:,idx] = (sat[:,idx]-cmin)/divide
#print(sat)
################PLACEHOLDER2 #end##########################
...
print('gradient decent coefficients',theta)
